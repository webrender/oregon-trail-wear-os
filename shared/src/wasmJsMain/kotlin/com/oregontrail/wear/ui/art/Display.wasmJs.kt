 ...
 * fixed 192dp, magnified by a whole number that the density carries — see `Main.kt`. So
 * this is 384 device pixels at 1x, 768 at 2x, and asking Compose's window info instead
 * would return the size of the page and have the art decoded several times larger than
