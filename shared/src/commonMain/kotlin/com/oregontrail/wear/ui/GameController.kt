...
import com.oregontrail.wear.platform.StorageLock
import com.oregontrail.wear.platform.seedFromClock
import com.oregontrail.wear.platform.storageDispatcher
...
class GameController(
     ...
     */
    saveScope: CoroutineScope = CoroutineScope(SupervisorJob() + storageDispatcher),
) {
     ...
     */
    private val fileLock = StorageLock()

    private fun perform(task: SaveTask) = fileLock.withLock {
        when (task) {
